...
CMD="echo Start to compile. && pushd $DIEGO_RELEASE_PATH && ./scripts/update && popd && source $LATTICE_SRC_PATH/pipeline/helpers/build_ltc_helpers && setup_go_env && construct_ltc_gopath && run_unit_tests && git_describe_lattice && go_build_ltc && generate_ltc_tarball $LATTICE_SRC_PATH"
